...
4.  **Baselines & Benchmarking**: Evaluated the model against comparative baselines (CoLight, NSTLight) and classical controllers.
...
Shows how the proposed model dampens congestion waves following an accident, compared to the unchecked propagation in baseline models.
