...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.45\textwidth]{../../FAST_VAL_RESULTS/plots/convergence_avg_queue_length.png}}
\caption{Convergence of Average Queue Length across training phases.}
\label{fig:convergence}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=0.45\textwidth]{../../FAST_VAL_RESULTS/plots/heatmap_mappo_(ours).png}}
